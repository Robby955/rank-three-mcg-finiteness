...
\date{Version 0.1.5-candidate\\14 August 2026}
...
and deformation machinery.  The included scripts verify only finite arithmetic
and fibrewise linear algebra; they are not substitutes for those geometric
inputs.
