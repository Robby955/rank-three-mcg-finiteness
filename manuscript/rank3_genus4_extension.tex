...
algebra; the TeX build checks only the document.  Non-load-bearing
countermodels and refuted side routes are intentionally omitted so that the
shortest proof graph remains visible.
...
Five}, companion candidate manuscript, version 0.1.5-candidate, 15 August
