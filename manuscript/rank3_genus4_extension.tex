...
This manuscript is unrefereed.  Finite scripts check only enumerations and
selected linear algebra; the TeX build checks only the document.  The
manuscript includes only arguments used in the proposed proof, and no
established theorem status is asserted.
...
R.~Sneiderman,
\emph{A Candidate Proof of Finite Image for Rank-Three Surface-Group
Representations in Genus at Least Five}, companion candidate manuscript,
version 0.1.6-candidate, 25 August 2026,
\url{https://github.com/Robby955/rank-three-mcg-finiteness}.
