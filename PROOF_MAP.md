...
| Sections 11--12, punctured and final high-HN branches | Uses the degree-two extension-naturality square and the final universal extension to produce rank-four quotient-normalizer subbundles | In `(S, q) = (2, 10)`, does the zero kernel map force the self-block class to vanish after pullback, and does parabolic stability make each full extension boundary injective? |
